...
My code is not entirely automated yet. I still receive some errors and I am unsure whether or not it is clean. 
...
My code produces the graph within reasonable approximation to the orginal
...
Outputs is not in a separate folder yet. 
...
The workflow of my code is good and contains at least one function.
...
I need to add more explanations to my documentation (README)
...
All my code contains a good amount of comments and they explain what a specific line does. The code also follows a consistent style. 
